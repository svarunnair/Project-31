...
import { Button, Flex, Grid, Img, Input, LinkBox, Text } from '@chakra-ui/react';
...
<Text  padding={"10px"} cursor={'pointer'} onClick={handleLogin}>LOGIN</Text>
<Text  padding={"10px"} cursor={'pointer'}>HELP</Text>
<Text  padding={"10px"} cursor={'pointer'}>SHOPPING BAG({})</Text>
